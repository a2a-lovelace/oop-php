...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$querier = new Toolkit();
	$res = $querier->setDepName($dep_id, $dep_name);
...
<html>
<head>
	<title>Set department name</title>
...
<?php if ($is_logged_in) { ?>
	...
	<div class = 'content'>
		<p>Insert the id and a new name of a department you wish to change:</p>
		<form method = 'post'>
		<p>Department id: <input type = 'number' name = 'dep_id' required></p>
		<p>Department name: <input type = 'text' name = 'dep_name' required></p>
		<p><input type = 'submit' value = 'Create'></p></form>
		<?php if (isset($res)): ?>
		    <p><?php echo 'Successfully changed the name of the department'; ?></p>
		<?php endif; ?>
	</div>
<?php } ?>
</body>